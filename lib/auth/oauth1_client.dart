...
class TumblrOAuth1Client {
  static const String _requestTokenUrl = 'https://www.tumblr.com/oauth/request_token';
  static const String _authorizeUrl = 'https://www.tumblr.com/oauth/authorize';
  static const String _accessTokenUrl = 'https://www.tumblr.com/oauth/access_token';
  ...
  Future<oauth1.Credentials> authorize() async {
    try {
      ...
      final requestTokenResponse = await _authorization.requestTemporaryCredentials(callbackUrlScheme);
  ...
  oauth1.Client createClient() {
    if (_credentials == null) {
      throw Exception('Not authorized. Call authorize() first or set credentials.');
    }
  ...
  Future<Map<String, dynamic>> get(String endpoint) async {
    ...
    final response = await client.get(Uri.parse('https://api.tumblr.com/v2/$endpoint'));
  ...
  Future<Map<String, dynamic>> getDashboard({int? limit, int? offset, String? type}) async {
  ...
  Future<Map<String, dynamic>> getBlogPosts(String blogIdentifier, {
    int? limit,
    int? offset,
    String? type,
  }) async {
